...
if (isset($_POST) & !empty($_POST)){
    ...
    if (  !empty($_POST['User_name']) &  !empty($_POST['Password']) & !empty($_POST['fullname'])) {
        $obj->Edit_admin_profile($_POST);
    }
                        ...
                        <div class="panel panel-info">
                                        ...
                                        <form class="form-group" method="post">
                                            <table class="table table-user-information">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input name="fullname" style="font-weight:500;olor:#DC143C;border-radius: 5px" type="text"  value="<?php if(isset($_SESSION['user_id'])){ echo $_SESSION['user_id']['Full_name'];} ?>" placeholder=" Full Name"  required></td>
                                                </tr>
                                                <tr>
                                                    <td style="font-weight:800;color:#2e2e2e;" >Username</td>
                                                    <td><input name="User_name" style="font-weight:500;olor:#DC143C;border-radius: 5px" type="text" value="<?php if(isset($_SESSION['user_id'])){ echo $_SESSION['user_id']['User_name'];} ?>" placeholder=" Username" required></td>
                                                </tr>
                                                <tr>
                                                    <td style="font-weight:800;color:#2e2e2e;">Mobile No</td>
                                                    <td><input name="Mobile" style="font-weight:500;olor:#DC143C;border-radius: 5px" type="number" value="<?php if(isset($_SESSION['user_id'])){ echo '0'.$_SESSION['user_id']['Mobile'];} ?>" placeholder=" Mobile No" required></td>
                                                </tr>
                                                <tr>
                            ...
                            <div class="panel-footer">
                                ...
                                <span class="pull-right">
                                    <button   type="submit" class="btn btn-primary" ><i class="fa fa-fw fa-gear"></i>Modify Data</button>

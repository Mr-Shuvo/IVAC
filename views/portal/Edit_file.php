...
if (isset($_GET) & !empty($_GET)){
    ...
    if ($_GET['edit']) {
        $fileId=$_GET['edit'] ;
        $allfiles=$obj->OneFiledata($fileId);
...
if (isset($_POST) & !empty($_POST)){
    ...
    if (  !empty($_POST['BGD']) &  !empty($_POST['Passport']) &  !empty($_POST['Mission']) &  !empty($_POST['Given_name']) ) {

        $obj->setfile($_POST)->EditOneFile($_GET['edit']);
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <tr>
                                                ...
                                                <td><select name="Mission" style="width:162px;font-weight:bold;color:#DC143C;border-radius: 5px " size="1">
                                                        <option style="font-weight:800;color: #2e2e2e" value="<?php if(isset($allfiles)){ echo $allfiles['Mission'];} ?>"> <?php if(isset($allfiles)){ echo $allfiles['Mission'];} ?> </option>
                                                ...
                                                <td><input type="text" name="BGD" style="font-weight:500;olor:#DC143C;border-radius: 5px"   value="<?php if(isset($allfiles)){ echo $allfiles['BGD'];} ?>" required> </td>

                                            </tr>
                                            <tr>
                                                <td style="font-weight:800;color:#2e2e2e;" >Passport</td>
                                                <td><input type="text" name="Passport" style="font-weight:500;olor:#DC143C;border-radius: 5px"   value="<?php if(isset($allfiles)){ echo $allfiles['Passport'];} ?>" required> </td>
                                            </tr>
                                            <tr>
                                                <td style="font-weight:800;color:#2e2e2e;" > Given Name</td>
                                                <td><input type="text" name="Given_name" style="font-weight:500;olor:#DC143C;border-radius: 5px"  value="<?php if(isset($allfiles)){ echo $allfiles['Given_name'];} ?>" required></td>
                                            </tr>
                                            <tr>
                                                <td style="font-weight:800;color:#2e2e2e;" >Birth Place</td>
                                                <td><input type="text" name="Birth_place" style="font-weight:500;olor:#DC143C;border-radius: 5px"  value="<?php if(isset($allfiles)){ echo $allfiles['Birth_place'];} ?>" required></td>
                                            </tr>
                                            <tr>
                                                <td style="font-weight:800;color:#2e2e2e;" >Father's Name</td>
                                                <td><input type="text" name="Father_name" style="font-weight:500;olor:#DC143C;border-radius: 5px"   value="<?php if(isset($allfiles)){ echo $allfiles['Father_name'];} ?>" required></td>
                                            </tr>
                                            <tr>
                                                <td style="font-weight:800;color:#2e2e2e;" >Mother's Name</td>
                                                <td><input type="text" name="Mother_name" style="font-weight:500;olor:#DC143C;border-radius: 5px"   value="<?php if(isset($allfiles)){ echo $allfiles['Mother_name'];} ?>" required></td>
                                            </tr>

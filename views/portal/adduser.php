...
if (isset($_POST) & !empty($_POST)){
    ...
    if (  !empty($_POST['User_name']) &  !empty($_POST['Password']) &  !empty($_POST['File_amount']) ) {
            $obj = new reg();
            $obj->setData($_POST)->Add_User();
    }

    else{
        $_SESSION['error']= " Check Your Filds !";
                                        ...
                                        <form class="form-group" method="post">
                                            <table class="table table-user-information">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input name="fullname" style="font-weight:500;olor:#DC143C;border-radius: 5px" type="text"  placeholder=" Full Name"  required></td>
                                                </tr>
                                                <tr>
                                                    <td style="font-weight:800;color:#2e2e2e;" >Username</td>
                                                    <td><input name="User_name" style="font-weight:500;olor:#DC143C;border-radius: 5px" type="text"  placeholder=" Username" required></td>
                                                </tr>
                                                <tr>
                                                    <td style="font-weight:800;color:#2e2e2e;">File Amount</td>
                                                    <td><input name="File_amount" style="font-weight:500;olor:#DC143C;border-radius: 5px" type="number"  placeholder=" Maximum 5" required></td>
                                                </tr>
                                                <tr>
                                                    <td style="font-weight:800;color:#2e2e2e;">Mobile No</td>
                                                    <td><input name="Mobile" style="font-weight:500;olor:#DC143C;border-radius: 5px" type="number"  placeholder=" Mobile No" required></td>
                                                </tr>
                                                <tr>
                                                    <td style="font-weight:800;color:#2e2e2e;">Reffer Email</td>
                                                    <td><input name="reffer_email" style="font-weight:500;olor:#DC143C;border-radius: 5px" type="email"  placeholder=" Reffer Email" required></td>
                                                </tr>
                                                <tr>
                                                    <td style="font-weight:800;color:#2e2e2e;">Password</td>
                                                    <td><input name="Password" style="font-weight:500;olor:#DC143C;border-radius: 5px" type="password"  placeholder=" Password" required></td>
                                                </tr>
                                                </tbody>
                                            </table>
                            ...
                            <div class="panel-footer">
                                ...
                                <span class="pull-right">
                                    <button   type="submit" class="btn btn-primary" ><i class="fa fa-fw fa-gear"></i>Add User</button>
                                     <a href="Admin.php" data-original-title="Remove this user" data-toggle="tooltip" type="button" class="btn btn-danger"> Cancel</a>
                        </span>
                            </div>
                            </form>
                        </div>
